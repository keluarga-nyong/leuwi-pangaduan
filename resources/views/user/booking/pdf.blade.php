        ...
        <table style="width:100%; border-collapse: collapse;">
            ...
            <tbody  style="border: 1px solid #000;">
                <tr >
                    ...
                    <td rowspan="6"  style="border: 1px solid #000; text-align: centerl"></td>
                </tr>
                <tr>
                    <td style="text-align:right;">Nama Penginapan :</td>
                    <td>{{$booking->villa->nama_villa}}</td>
                </tr>
                <tr>
                    <td style="text-align:right;">Check In :</td>
                    <td>{{date('d/m/Y',strtotime($booking->checkin))}}</td>
                </tr>
                <tr>
                    <td style="text-align:right;">Check Out :</td>
